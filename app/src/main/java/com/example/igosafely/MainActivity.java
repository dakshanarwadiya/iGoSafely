...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.eigth).setOnClickListener(this);
    }
    ...
    public void onClick(View view) {
        int id = view.getId();
        if (id == R.id.fourth) {
            startActivity(new Intent(MainActivity.this, DeveloperByActivity.class));
            MainActivity.this.finish();
        }else if(id == R.id.first){
            startActivity(new Intent(MainActivity.this, AddRelative.class));
            MainActivity.this.finish();
        }else if(id == R.id.fifth){
            startActivity(new Intent(MainActivity.this, HowToSwipe.class));
            MainActivity.this.finish();
        } else if(id == R.id.second){
            startActivity(new Intent(MainActivity.this, helplineCall.class));
            MainActivity.this.finish();
        } else if(id == R.id.third) {
            startActivity(new Intent(MainActivity.this, TrigActivity.class));
            MainActivity.this.finish();
        } else if(id == R.id.sixth) {
            startActivity(new Intent(MainActivity.this, LawsActivity.class));
            MainActivity.this.finish();
        } else if(id == R.id.seventh) {
            startActivity(new Intent(MainActivity.this, SelfDefenceActivity.class));
